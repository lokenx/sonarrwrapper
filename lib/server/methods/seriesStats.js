Meteor.methods({
  seriesStats: function(tvdb){
    ...
    try {
      ...
      console.log("Sonarr Series Stats All Shows List -> " + e.message);
    ...
    try {
      var response = HTTP.call("GET", Sonarr.url + ":" + Sonarr.port + Sonarr.directory + "/api/series/" + sonarrId, {headers: {"X-Api-Key":Sonarr.api}, timeout: 2000} );
    } catch (e) {
